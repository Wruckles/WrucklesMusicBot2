module.exports = {
  ...
  SupportServer: "https://discord.gg/3E9BgEUZCf", // Support Server Link
  Token: process.env.Token || "ODAwNDc5OTUxODQ5MTI3OTQ2.G7lQrt.FNFxmtcOou8Tx1D1VF2OtQhbFVkh23zMTv0uio", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "800479951849127946", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "v60QhJ9q0J3owv4dGicxsPCOLV7wqmK4", // Discord Client Secret
  ...
  IconURL:
    "https://raw.githubusercontent.com/Wruckles/Wruckusbot/main/assets/sh.gif", // URL of all embed author icons | Dont edit unless you dont need that Music CD Spining
  ...
  Presence: {
    ...
    name: "With Wruckles", // The message shown
  ...
  Lavalink: {
    id: "Wruckles", //- Used for indentifier. You can set this to whatever you want.
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "0dfa0b13ec264e94862ad3de3a251b9d", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "753af51762f341e1974c986a1eddb366", // Spotify Client Secret
  },
};
